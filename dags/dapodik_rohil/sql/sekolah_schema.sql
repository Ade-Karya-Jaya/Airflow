...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_rohil"."sekolah";
CREATE TABLE "dapodik_rohil"."sekolah" (
  "sekolah_id" uuid,
...
;
ALTER TABLE "dapodik_rohil"."sekolah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE UNIQUE INDEX "sekolah_pk" ON "dapodik_rohil"."sekolah" USING btree (
...
-- ----------------------------
ALTER TABLE "dapodik_rohil"."sekolah" ADD CONSTRAINT "pk_sekolah" PRIMARY KEY ("sekolah_id");