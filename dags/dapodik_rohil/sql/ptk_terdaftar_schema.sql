...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_rohil"."ptk_terdaftar";
CREATE TABLE "dapodik_rohil"."ptk_terdaftar" (
...
;
ALTER TABLE "dapodik_rohil"."ptk_terdaftar" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "ptk_terdaftar_idx" ON "dapodik_rohil"."ptk_terdaftar" USING btree (
  "ptk_terdaftar_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ptk_terdaftar_sekolah_idx" ON "dapodik_rohil"."ptk_terdaftar" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ptk_terdaftar_ptk_idx" ON "dapodik_rohil"."ptk_terdaftar" USING btree (
