...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_rohil"."sanitasi";
CREATE TABLE "dapodik_rohil"."sanitasi" (
...
;
ALTER TABLE "dapodik_rohil"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik_rohil"."sanitasi" USING btree (
