...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_kuansing"."alat";
CREATE TABLE "dapodik_kuansing"."alat" (
  "id_ruang" uuid,
...
;
ALTER TABLE "dapodik_kuansing"."alat" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "alat_idx" ON "dapodik_kuansing"."alat" USING btree (
  "id_alat" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "alat_sekolah_idx" ON "dapodik_kuansing"."alat" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "alat_ruang_idx" ON "dapodik_kuansing"."alat" USING btree (
