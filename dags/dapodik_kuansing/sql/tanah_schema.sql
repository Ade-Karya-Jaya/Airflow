...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_kuansing"."tanah";
CREATE TABLE "dapodik_kuansing"."tanah" (
...
;
ALTER TABLE "dapodik_kuansing"."tanah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "tanah_idx" ON "dapodik_kuansing"."tanah" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "tanah_sekolah_idx" ON "dapodik_kuansing"."tanah" USING btree (
