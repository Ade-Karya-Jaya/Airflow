...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_kuansing"."ptk";
CREATE TABLE "dapodik_kuansing"."ptk" (
  "ptk_id" uuid,
...
;
ALTER TABLE "dapodik_kuansing"."ptk" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "ptk_idx" ON "dapodik_kuansing"."ptk" USING btree (
  "ptk_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ptk_sekolah_idx" ON "dapodik_kuansing"."ptk" USING btree (
