...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_kuansing"."sanitasi";
CREATE TABLE "dapodik_kuansing"."sanitasi" (
...
;
ALTER TABLE "dapodik_kuansing"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik_kuansing"."sanitasi" USING btree (
