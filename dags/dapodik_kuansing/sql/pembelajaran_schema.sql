...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_kuansing"."pembelajaran";
CREATE TABLE "dapodik_kuansing"."pembelajaran" (
...
;
ALTER TABLE "dapodik_kuansing"."pembelajaran" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "pembelajaran_idx" ON "dapodik_kuansing"."pembelajaran" USING btree (
  "pembelajaran_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "pembelajaran_sekolah_idx" ON "dapodik_kuansing"."pembelajaran" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "rombongan_belajar_id_idx" ON "dapodik_kuansing"."pembelajaran" USING btree (
