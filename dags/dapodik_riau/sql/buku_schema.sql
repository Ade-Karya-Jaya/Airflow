...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_riau"."buku";
CREATE TABLE "dapodik_riau"."buku" (
...
;
ALTER TABLE "dapodik_riau"."buku" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "buku_idx" ON "dapodik_riau"."buku" USING btree (
  "id_buku" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "buku_sekolah_idx" ON "dapodik_riau"."buku" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "buku_ruang_idx" ON "dapodik_riau"."buku" USING btree (
