...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_riau"."sekolah";
CREATE TABLE "dapodik_riau"."sekolah" (
  "sekolah_id" uuid,
...
;
ALTER TABLE "dapodik_riau"."sekolah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE UNIQUE INDEX "sekolah_pk" ON "dapodik_riau"."sekolah" USING btree (
...
-- ----------------------------
ALTER TABLE "dapodik_riau"."sekolah" ADD CONSTRAINT "pk_sekolah" PRIMARY KEY ("sekolah_id");