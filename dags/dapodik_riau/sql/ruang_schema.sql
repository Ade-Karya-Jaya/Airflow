...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_riau"."ruang";
CREATE TABLE "dapodik_riau"."ruang" (
...
;
ALTER TABLE "dapodik_riau"."ruang" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "ruang_idx" ON "dapodik_riau"."ruang" USING btree (
  "id_ruang" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ruang_sekolah_idx" ON "dapodik_riau"."ruang" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ruang_tanah_idx" ON "dapodik_riau"."ruang" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ruang_bangunan_idx" ON "dapodik_riau"."ruang" USING btree (
