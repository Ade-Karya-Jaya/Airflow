...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_meranti"."sekolah";
CREATE TABLE "dapodik_meranti"."sekolah" (
  "sekolah_id" uuid,
...
;
ALTER TABLE "dapodik_meranti"."sekolah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE UNIQUE INDEX "sekolah_pk" ON "dapodik_meranti"."sekolah" USING btree (
...
-- ----------------------------
ALTER TABLE "dapodik_meranti"."sekolah" ADD CONSTRAINT "pk_sekolah" PRIMARY KEY ("sekolah_id");