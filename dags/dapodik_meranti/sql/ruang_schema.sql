...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_meranti"."ruang";
CREATE TABLE "dapodik_meranti"."ruang" (
...
;
ALTER TABLE "dapodik_meranti"."ruang" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "ruang_idx" ON "dapodik_meranti"."ruang" USING btree (
  "id_ruang" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ruang_sekolah_idx" ON "dapodik_meranti"."ruang" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ruang_tanah_idx" ON "dapodik_meranti"."ruang" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ruang_bangunan_idx" ON "dapodik_meranti"."ruang" USING btree (
