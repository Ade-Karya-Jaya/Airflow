...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_meranti"."sanitasi";
CREATE TABLE "dapodik_meranti"."sanitasi" (
...
;
ALTER TABLE "dapodik_meranti"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik_meranti"."sanitasi" USING btree (
