...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_bengkalis"."tanah";
CREATE TABLE "dapodik_bengkalis"."tanah" (
...
;
ALTER TABLE "dapodik_bengkalis"."tanah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "tanah_idx" ON "dapodik_bengkalis"."tanah" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "tanah_sekolah_idx" ON "dapodik_bengkalis"."tanah" USING btree (
