...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_bengkalis"."sanitasi";
CREATE TABLE "dapodik_bengkalis"."sanitasi" (
...
;
ALTER TABLE "dapodik_bengkalis"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik_bengkalis"."sanitasi" USING btree (
