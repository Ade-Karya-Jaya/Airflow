...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_bengkalis"."buku";
CREATE TABLE "dapodik_bengkalis"."buku" (
...
;
ALTER TABLE "dapodik_bengkalis"."buku" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "buku_idx" ON "dapodik_bengkalis"."buku" USING btree (
  "id_buku" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "buku_sekolah_idx" ON "dapodik_bengkalis"."buku" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "buku_ruang_idx" ON "dapodik_bengkalis"."buku" USING btree (
