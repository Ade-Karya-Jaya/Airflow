...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_bengkalis"."angkutan";
CREATE TABLE "dapodik_bengkalis"."angkutan" (
...
;
ALTER TABLE "dapodik_bengkalis"."angkutan" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "angkutan_idx" ON "dapodik_bengkalis"."angkutan" USING btree (
  "id_angkutan" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "angkutan_sekolah_idx" ON "dapodik_bengkalis"."angkutan" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "angkutan_ptk_idx" ON "dapodik_bengkalis"."angkutan" USING btree (
