...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_emis"."peserta_didik";
CREATE TABLE "dapodik_emis"."peserta_didik" (
...
;
ALTER TABLE "dapodik_emis"."peserta_didik" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "peserta_didik_idx" ON "dapodik_emis"."peserta_didik" USING btree (
  "peserta_didik_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "pd_sekolah_idx" ON "dapodik_emis"."peserta_didik" USING btree (
