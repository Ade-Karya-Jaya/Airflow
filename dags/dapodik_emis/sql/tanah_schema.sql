...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_emis"."tanah";
CREATE TABLE "dapodik_emis"."tanah" (
...
;
ALTER TABLE "dapodik_emis"."tanah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "tanah_idx" ON "dapodik_emis"."tanah" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "tanah_sekolah_idx" ON "dapodik_emis"."tanah" USING btree (
