...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_emis"."sanitasi";
CREATE TABLE "dapodik_emis"."sanitasi" (
...
;
ALTER TABLE "dapodik_emis"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik_emis"."sanitasi" USING btree (
