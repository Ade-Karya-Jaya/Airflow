...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_emis"."sekolah";
CREATE TABLE "dapodik_emis"."sekolah" (
  "sekolah_id" uuid,
...
;
ALTER TABLE "dapodik_emis"."sekolah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE UNIQUE INDEX "sekolah_pk" ON "dapodik_emis"."sekolah" USING btree (
...
-- ----------------------------
ALTER TABLE "dapodik_emis"."sekolah" ADD CONSTRAINT "pk_sekolah" PRIMARY KEY ("sekolah_id");