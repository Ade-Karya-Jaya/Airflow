...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_dumai"."sanitasi";
CREATE TABLE "dapodik_dumai"."sanitasi" (
...
;
ALTER TABLE "dapodik_dumai"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik_dumai"."sanitasi" USING btree (
