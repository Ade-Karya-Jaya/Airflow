...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_dumai"."buku";
CREATE TABLE "dapodik_dumai"."buku" (
...
;
ALTER TABLE "dapodik_dumai"."buku" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "buku_idx" ON "dapodik_dumai"."buku" USING btree (
  "id_buku" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "buku_sekolah_idx" ON "dapodik_dumai"."buku" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "buku_ruang_idx" ON "dapodik_dumai"."buku" USING btree (
