...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_dumai"."tanah";
CREATE TABLE "dapodik_dumai"."tanah" (
...
;
ALTER TABLE "dapodik_dumai"."tanah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "tanah_idx" ON "dapodik_dumai"."tanah" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "tanah_sekolah_idx" ON "dapodik_dumai"."tanah" USING btree (
