...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_dumai"."sekolah";
CREATE TABLE "dapodik_dumai"."sekolah" (
  "sekolah_id" uuid,
...
;
ALTER TABLE "dapodik_dumai"."sekolah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE UNIQUE INDEX "sekolah_pk" ON "dapodik_dumai"."sekolah" USING btree (
...
-- ----------------------------
ALTER TABLE "dapodik_dumai"."sekolah" ADD CONSTRAINT "pk_sekolah" PRIMARY KEY ("sekolah_id");