...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_kampar"."sekolah";
CREATE TABLE "dapodik_kampar"."sekolah" (
  "sekolah_id" uuid,
...
;
ALTER TABLE "dapodik_kampar"."sekolah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE UNIQUE INDEX "sekolah_pk" ON "dapodik_kampar"."sekolah" USING btree (
...
-- ----------------------------
ALTER TABLE "dapodik_kampar"."sekolah" ADD CONSTRAINT "pk_sekolah" PRIMARY KEY ("sekolah_id");