...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_kampar"."tanah";
CREATE TABLE "dapodik_kampar"."tanah" (
...
;
ALTER TABLE "dapodik_kampar"."tanah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "tanah_idx" ON "dapodik_kampar"."tanah" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "tanah_sekolah_idx" ON "dapodik_kampar"."tanah" USING btree (
