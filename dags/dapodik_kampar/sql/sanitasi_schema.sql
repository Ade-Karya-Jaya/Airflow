...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_kampar"."sanitasi";
CREATE TABLE "dapodik_kampar"."sanitasi" (
...
;
ALTER TABLE "dapodik_kampar"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik_kampar"."sanitasi" USING btree (
