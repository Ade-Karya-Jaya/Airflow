-- ----------------------------
-- Schema for dapodik_kampar
-- ----------------------------
CREATE SCHEMA IF NOT EXISTS dapodik_kampar AUTHORIZATION postgres;

-- ----------------------------
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_kampar"."rombongan_belajar";
CREATE TABLE "dapodik_kampar"."rombongan_belajar" (
...
;
ALTER TABLE "dapodik_kampar"."rombongan_belajar" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "rombongan_belajar_idx" ON "dapodik_kampar"."rombongan_belajar" USING btree (
  "rombongan_belajar_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "rombongan_belajar_sekolah_idx" ON "dapodik_kampar"."rombongan_belajar" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "rombongan_belajar_ruang_idx" ON "dapodik_kampar"."rombongan_belajar" USING btree (
