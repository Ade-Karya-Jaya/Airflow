...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_inhil"."buku";
CREATE TABLE "dapodik_inhil"."buku" (
...
;
ALTER TABLE "dapodik_inhil"."buku" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "buku_idx" ON "dapodik_inhil"."buku" USING btree (
  "id_buku" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "buku_sekolah_idx" ON "dapodik_inhil"."buku" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "buku_ruang_idx" ON "dapodik_inhil"."buku" USING btree (
