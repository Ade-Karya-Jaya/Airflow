...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_inhil"."sanitasi";
CREATE TABLE "dapodik_inhil"."sanitasi" (
...
;
ALTER TABLE "dapodik_inhil"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik_inhil"."sanitasi" USING btree (
