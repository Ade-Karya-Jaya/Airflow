...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_inhil"."tanah";
CREATE TABLE "dapodik_inhil"."tanah" (
...
;
ALTER TABLE "dapodik_inhil"."tanah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "tanah_idx" ON "dapodik_inhil"."tanah" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "tanah_sekolah_idx" ON "dapodik_inhil"."tanah" USING btree (
