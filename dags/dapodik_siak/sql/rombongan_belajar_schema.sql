...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_siak"."rombongan_belajar";
CREATE TABLE "dapodik_siak"."rombongan_belajar" (
...
;
ALTER TABLE "dapodik_siak"."rombongan_belajar" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "rombongan_belajar_idx" ON "dapodik_siak"."rombongan_belajar" USING btree (
  "rombongan_belajar_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "rombongan_belajar_sekolah_idx" ON "dapodik_siak"."rombongan_belajar" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "rombongan_belajar_ruang_idx" ON "dapodik_siak"."rombongan_belajar" USING btree (
