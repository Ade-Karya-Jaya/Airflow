...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_siak"."sanitasi";
CREATE TABLE "dapodik_siak"."sanitasi" (
...
;
ALTER TABLE "dapodik_siak"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik_siak"."sanitasi" USING btree (
