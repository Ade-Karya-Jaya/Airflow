...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_siak"."ruang";
CREATE TABLE "dapodik_siak"."ruang" (
...
;
ALTER TABLE "dapodik_siak"."ruang" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "ruang_idx" ON "dapodik_siak"."ruang" USING btree (
  "id_ruang" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ruang_sekolah_idx" ON "dapodik_siak"."ruang" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ruang_tanah_idx" ON "dapodik_siak"."ruang" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ruang_bangunan_idx" ON "dapodik_siak"."ruang" USING btree (
