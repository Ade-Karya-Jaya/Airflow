...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_siak"."tanah";
CREATE TABLE "dapodik_siak"."tanah" (
...
;
ALTER TABLE "dapodik_siak"."tanah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "tanah_idx" ON "dapodik_siak"."tanah" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "tanah_sekolah_idx" ON "dapodik_siak"."tanah" USING btree (
