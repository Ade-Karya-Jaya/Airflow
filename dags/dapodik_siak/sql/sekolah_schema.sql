...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_siak"."sekolah";
CREATE TABLE "dapodik_siak"."sekolah" (
  "sekolah_id" uuid,
...
;
ALTER TABLE "dapodik_siak"."sekolah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE UNIQUE INDEX "sekolah_pk" ON "dapodik_siak"."sekolah" USING btree (
...
-- ----------------------------
ALTER TABLE "dapodik_siak"."sekolah" ADD CONSTRAINT "pk_sekolah" PRIMARY KEY ("sekolah_id");