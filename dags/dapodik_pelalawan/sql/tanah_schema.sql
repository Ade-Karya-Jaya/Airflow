...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_pelalawan"."tanah";
CREATE TABLE "dapodik_pelalawan"."tanah" (
...
;
ALTER TABLE "dapodik_pelalawan"."tanah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "tanah_idx" ON "dapodik_pelalawan"."tanah" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "tanah_sekolah_idx" ON "dapodik_pelalawan"."tanah" USING btree (
