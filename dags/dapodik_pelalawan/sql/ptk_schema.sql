...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_pelalawan"."ptk";
CREATE TABLE "dapodik_pelalawan"."ptk" (
  "ptk_id" uuid,
...
;
ALTER TABLE "dapodik_pelalawan"."ptk" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "ptk_idx" ON "dapodik_pelalawan"."ptk" USING btree (
  "ptk_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ptk_sekolah_idx" ON "dapodik_pelalawan"."ptk" USING btree (
