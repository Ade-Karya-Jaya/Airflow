...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_pelalawan"."sanitasi";
CREATE TABLE "dapodik_pelalawan"."sanitasi" (
...
;
ALTER TABLE "dapodik_pelalawan"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik_pelalawan"."sanitasi" USING btree (
