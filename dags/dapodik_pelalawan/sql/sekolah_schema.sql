...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_pelalawan"."sekolah";
CREATE TABLE "dapodik_pelalawan"."sekolah" (
  "sekolah_id" uuid,
...
;
ALTER TABLE "dapodik_pelalawan"."sekolah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE UNIQUE INDEX "sekolah_pk" ON "dapodik_pelalawan"."sekolah" USING btree (
...
-- ----------------------------
ALTER TABLE "dapodik_pelalawan"."sekolah" ADD CONSTRAINT "pk_sekolah" PRIMARY KEY ("sekolah_id");