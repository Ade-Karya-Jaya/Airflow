...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_rohul"."sekolah";
CREATE TABLE "dapodik_rohul"."sekolah" (
  "sekolah_id" uuid,
...
;
ALTER TABLE "dapodik_rohul"."sekolah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE UNIQUE INDEX "sekolah_pk" ON "dapodik_rohul"."sekolah" USING btree (
...
-- ----------------------------
ALTER TABLE "dapodik_rohul"."sekolah" ADD CONSTRAINT "pk_sekolah" PRIMARY KEY ("sekolah_id");