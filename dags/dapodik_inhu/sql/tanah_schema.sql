...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_inhu"."tanah";
CREATE TABLE "dapodik_inhu"."tanah" (
...
;
ALTER TABLE "dapodik_inhu"."tanah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "tanah_idx" ON "dapodik_inhu"."tanah" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "tanah_sekolah_idx" ON "dapodik_inhu"."tanah" USING btree (
