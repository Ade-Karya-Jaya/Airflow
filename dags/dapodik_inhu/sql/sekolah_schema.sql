...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_inhu"."sekolah";
CREATE TABLE "dapodik_inhu"."sekolah" (
  "sekolah_id" uuid,
...
;
ALTER TABLE "dapodik_inhu"."sekolah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE UNIQUE INDEX "sekolah_pk" ON "dapodik_inhu"."sekolah" USING btree (
...
-- ----------------------------
ALTER TABLE "dapodik_inhu"."sekolah" ADD CONSTRAINT "pk_sekolah" PRIMARY KEY ("sekolah_id");