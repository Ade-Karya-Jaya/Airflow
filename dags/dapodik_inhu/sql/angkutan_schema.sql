...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_inhu"."angkutan";
CREATE TABLE "dapodik_inhu"."angkutan" (
...
;
ALTER TABLE "dapodik_inhu"."angkutan" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "angkutan_idx" ON "dapodik_inhu"."angkutan" USING btree (
  "id_angkutan" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "angkutan_sekolah_idx" ON "dapodik_inhu"."angkutan" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "angkutan_ptk_idx" ON "dapodik_inhu"."angkutan" USING btree (
