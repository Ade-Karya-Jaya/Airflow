...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_inhu"."pembelajaran";
CREATE TABLE "dapodik_inhu"."pembelajaran" (
...
;
ALTER TABLE "dapodik_inhu"."pembelajaran" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "pembelajaran_idx" ON "dapodik_inhu"."pembelajaran" USING btree (
  "pembelajaran_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "pembelajaran_sekolah_idx" ON "dapodik_inhu"."pembelajaran" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "rombongan_belajar_id_idx" ON "dapodik_inhu"."pembelajaran" USING btree (
