...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_inhu"."sanitasi";
CREATE TABLE "dapodik_inhu"."sanitasi" (
...
;
ALTER TABLE "dapodik_inhu"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik_inhu"."sanitasi" USING btree (
