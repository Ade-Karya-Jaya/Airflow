...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_inhu"."bangunan";
CREATE TABLE "dapodik_inhu"."bangunan" (
...
;
ALTER TABLE "dapodik_inhu"."bangunan" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "bangunan_idx" ON "dapodik_inhu"."bangunan" USING btree (
  "id_bangunan" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "bangunan_sekolah_idx" ON "dapodik_inhu"."bangunan" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "bangunan_tanah_idx" ON "dapodik_inhu"."bangunan" USING btree (
