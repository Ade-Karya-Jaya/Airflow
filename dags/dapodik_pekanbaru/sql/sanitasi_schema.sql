...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_pekanbaru"."sanitasi";
CREATE TABLE "dapodik_pekanbaru"."sanitasi" (
...
;
ALTER TABLE "dapodik_pekanbaru"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik_pekanbaru"."sanitasi" USING btree (
