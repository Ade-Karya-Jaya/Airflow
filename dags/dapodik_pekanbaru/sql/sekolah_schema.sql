...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_pekanbaru"."sekolah";
CREATE TABLE "dapodik_pekanbaru"."sekolah" (
  "sekolah_id" uuid,
...
;
ALTER TABLE "dapodik_pekanbaru"."sekolah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE UNIQUE INDEX "sekolah_pk" ON "dapodik_pekanbaru"."sekolah" USING btree (
...
-- ----------------------------
ALTER TABLE "dapodik_pekanbaru"."sekolah" ADD CONSTRAINT "pk_sekolah" PRIMARY KEY ("sekolah_id");