...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_pekanbaru"."bangunan";
CREATE TABLE "dapodik_pekanbaru"."bangunan" (
...
;
ALTER TABLE "dapodik_pekanbaru"."bangunan" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "bangunan_idx" ON "dapodik_pekanbaru"."bangunan" USING btree (
  "id_bangunan" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "bangunan_sekolah_idx" ON "dapodik_pekanbaru"."bangunan" USING btree (
  "sekolah_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "bangunan_tanah_idx" ON "dapodik_pekanbaru"."bangunan" USING btree (
