...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik_pekanbaru"."tanah";
CREATE TABLE "dapodik_pekanbaru"."tanah" (
...
;
ALTER TABLE "dapodik_pekanbaru"."tanah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "tanah_idx" ON "dapodik_pekanbaru"."tanah" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "tanah_sekolah_idx" ON "dapodik_pekanbaru"."tanah" USING btree (
