...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik"."sanitasi";
CREATE TABLE "dapodik"."sanitasi" (
...
;
ALTER TABLE "dapodik"."sanitasi" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "sanitasi_sekolah_idx" ON "dapodik"."sanitasi" USING btree (
