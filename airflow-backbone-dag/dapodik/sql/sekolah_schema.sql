...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik"."sekolah";
...
;
ALTER TABLE "dapodik"."sekolah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

-- CREATE UNIQUE INDEX "sekolah_pk" ON "dapodik"."sekolah" USING btree (
...
-- ----------------------------
-- ALTER TABLE "dapodik"."sekolah" ADD CONSTRAINT "pk_sekolah" PRIMARY KEY ("sekolah_id");