...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik"."ptk";
CREATE TABLE "dapodik"."ptk" (
...
;
ALTER TABLE "dapodik"."ptk" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "ptk_idx" ON "dapodik"."ptk" USING btree (
  "ptk_id" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "ptk_sekolah_idx" ON "dapodik"."ptk" USING btree (
