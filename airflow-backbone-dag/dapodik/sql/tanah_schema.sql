...
-- Table structure 
-- ----------------------------
DROP TABLE IF EXISTS "dapodik"."tanah";
...
;
ALTER TABLE "dapodik"."tanah" OWNER TO "postgres";

-- ----------------------------
-- Indexes structure 
-- ----------------------------

CREATE INDEX "tanah_idx" ON "dapodik"."tanah" USING btree (
  "id_tanah" "pg_catalog"."uuid_ops" ASC NULLS LAST
);

CREATE INDEX "tanah_sekolah_idx" ON "dapodik"."tanah" USING btree (
